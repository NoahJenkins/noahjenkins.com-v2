...
export class CommandProcessor {
  ...
  private projects(): string[] {
    return [
      ...
      '',
      '☕ Coffee Shop Website (Completed)',
      '   Modern coffee shop website with responsive design',
      '   Tech: Next.js, React, CSS, Vercel',
      '   Live: coffee-shop-next-js-site.vercel.app | Code: github.com/NoahJenkins/Coffee-Shop-Next-JS-Site',
      '',
      ...
      '   Live: muttsnsuch.com',
      '',
      '🎨 CSS Gradient Generator (Active)',
      '   Interactive tool for creating custom CSS gradients',
      '   Tech: Next.js, TypeScript, Tailwind CSS, CSS',
      '   Live: noahjenkins.com/tools/css-generator',
      '',
